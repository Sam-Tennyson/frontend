  ...
  return (
    ...
    <div className="w-4/5 m-auto text-justify font-abc">
      ...
      <p>
        ...
        the information you find on this website (Fun-with-js), is strictly at
        your own risk. Fun-with-js will not be liable for any losses and/or
      ...
      <h2 className="my-4 text-2xl font-bold">Update</h2>
