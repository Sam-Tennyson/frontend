  ...
  return (
    ...
    <div className="w-4/5 m-auto text-justify font-abc">
      ...
      <p>
        ...
        shared and/or collect in Fun-with-js. This policy is not applicable to
        any information collected offline or via channels other than this
        website.
      </p>

      <h2 className="my-4 text-2xl font-bold">Consent</h2>
      ...
      <h2 className="my-4 text-2xl font-bold">Information we collect</h2>
      ...
      <h2 className="my-4 text-2xl font-bold">How we use your information</h2>
      ...
      <h2 className="my-4 text-2xl font-bold">Log Files</h2>
      ...
      <p>
        ...
        advertising partners of Fun-with-js.
      </p>
      ...
      <p>
        Note that Fun-with-js has no access to or control over these cookies
      ...
      <h2 className="my-4 text-2xl font-bold">GDPR Data Protection Rights</h2>
      ...
      <p>
        Fun-with-js does not knowingly collect any Personal Identifiable
