  ...
  return (
    ...
    <div className="w-4/5 m-auto text-justify font-abc">
      ...
      <p>
        ...
        conditions. Do not continue to use Fun-wth-js if you do not agree to
      ...
      <p>
        Unless otherwise stated, Fun-wth-js and/or its licensors own the
        intellectual property rights for all material on Fun-wth-js. All
        intellectual property rights are reserved. You may access this from
        Fun-wth-js for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-disc">
        <li>Republish material from Fun-wth-js</li>
        <li>Sell, rent or sub-license material from Fun-wth-js</li>
        <li>Reproduce, duplicate or copy material from Fun-wth-js</li>
        <li>Redistribute content from Fun-wth-js</li>
      </ul>
      ...
      <p>
        ...
        Fun-wth-js does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Fun-wth-js,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Fun-wth-js shall not be
      ...
      <p>
        Fun-wth-js reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Fun-wth-js a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        e-mail to Fun-wth-js. Please include your name, your organization name,
